...
// inputClass base
const inputClass = "w-full px-3 py-2 text-sm text-slate-800 border border-slate-200 rounded-lg focus:outline-none focus:border-cyan-500 transition-colors bg-white";
